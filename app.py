    ...
    if st.button("Gerar Credencial em PDF"):
        ...
        if cpf_limpo:
            ...
            if participante.empty:
                ...
                draw.text((x_dir, y_verso), "Evento", fill="black", font=fonte_titulo, anchor="mm")
                draw.text((x_dir, y_verso + 40), "FEIBAM | Feira de Equipamentos e\nInovações Multimarcas na Bahia - 2026", fill="black", font=fonte_padrao, anchor="mm", align="center")
                
                draw.text((x_dir, y_verso + 110), "Local", fill="black", font=fonte_titulo, anchor="mm")
                draw.text((x_dir, y_verso + 140), "Ville Conventions", fill="black", font=fonte_padrao, anchor="mm")
                
                draw.text((x_dir, y_verso + 200), "Data inicial", fill="black", font=fonte_titulo, anchor="mm")
                draw.text((x_dir, y_verso + 230), "01/05/2026 00:00:00 08:00", fill="black", font=fonte_padrao, anchor="mm")
                
                draw.text((x_dir, y_verso + 290), "Data final", fill="black", font=fonte_titulo, anchor="mm")
                draw.text((x_dir, y_verso + 320), "02/05/2026 00:00:00 21:00", fill="black", font=fonte_padrao, anchor="mm")
                
                draw.text((x_dir, y_verso + 380), "Inscrição", fill="black", font=fonte_titulo, anchor="mm")
                draw.text((x_dir, y_verso + 410), categoria, fill=cor_tema, font=fonte_padrao, anchor="mm")
